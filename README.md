...
## :pencil: Description
**SmartProfil** is a shopping website which sells all kinds of aluminium and PVC window profiles, window sills and a wide variety of window and door accessories.It has products with categories, manufacturers and a product cart.There are also modal plugin to add dialogs to your site for lightboxes, user notifications, or completely custom content for certain actions.           
